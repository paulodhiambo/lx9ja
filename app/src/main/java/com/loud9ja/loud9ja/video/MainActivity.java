package com.loud9ja.loud9ja.video;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        ((Loud9ja) this.getApplication()).setMeeting(meeting);
        //
        ...
        findViewById(R.id.btnCopyContent).setOnClickListener(v -> copyTextToClipboard(meetingId));

        btnAudioSelection.setOnClickListener(v -> showAudioInputDialog());
    ...
    private final MeetingEventListener meetingEventListener = new MeetingEventListener() {
        ...
        public void onMeetingJoined() {
            ...
            meeting.pubSub.subscribe("CHAT", pubSubMessage -> {
